...
def main():
    put_markdown('¡Bienvenido a la calculadora de métodos númericos!👋🚀')
    put_markdown('Desarrollado por Juan José Wilches Rivas, Brahyan Esteban Rios Soto, Diego Velásquez Varela')
    # Opciones de metodos 
    indice = ['Bisección', 'Regla Falsa','Punto Fijo','Newton','Secante','Raices Multiples'
    ,'Gauss','Gauss con Pivoteo parcial','Gauss con Pivoteo Total','Factorización LU','Jacobi','Gauss Sediel','Splines','Diferencias Divididas',
